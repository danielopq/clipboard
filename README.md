...
Frontend development for an IT website. It is optimized for desktop and mobile users (480px). The elements have been set according to the images provided. The website has been built with HTML and CSS.
...
- Live Site URL: [https://danielmartinez.co.uk/clipboard]
